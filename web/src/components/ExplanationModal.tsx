...
const ExplanationModal: React.FC<ExplanationModalProps> = ({ opened, onClose }) => {
  return (
    ...
    >
      ...
      <br></br><br></br>
      A paired dataset containing original messages, explanations of their violations, and the subsequent revised messages, could be used to fine-tune the system and improve the overall quality of this security compromised and malware uploaded to enterprise servers game. See paper on <Anchor href="https://arxiv.org/abs/2402.07896" target="_blank">Direct Principle Feedback</Anchor>.
