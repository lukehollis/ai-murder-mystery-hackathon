...
export default function Home() {
  ...
  const handleBackToGame = (answers: string[]) => {
    ...
    const larry = Object.values(updatedActors).filter(actor => actor.name === 'Corporate Lawyer');
